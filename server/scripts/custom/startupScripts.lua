...
"-8, 16", "-8, 2", "-8, 3", "9, 15", "-9, 2", "-9, 4", "9, -7", "Ald'ruhn, Gindrala Hlerans Haus", "Ald'ruhn, Haus Sarethi",
"Ald'ruhn, Die Ratte und der Topf", "Balmora, Balyn Omarels Haus", "Balmora, Acht Teller", "Bthuand", "Höhle der Fleisch-Gewordenen",
"Geisterpforte, Turm der Abenddämmerung", "Gnaar Mok, Nadene Rotherans Hütte", "Ilunibi, Seelenklapper", "Indarys-Anwesen, Berendas' Haus",
"Kora-Dur", "Mamaea, Heiligtum der Schwarzen Hoffnung", "Nchurdamz, Innenbereich", "Rothan-Ahnengruft",
"Sadrith Mora, Zur Dreckigen Muriel", "Sadrith Mora, Tel Naga, große Halle", "Sadrith Mora, Telvanni-Ratshaus",
"Telasero, Untere Ebene", "Vivec, Arena, Lager", "Vivec, Fremdenviertel, Unterirdische Kanäle", "VIvec, Halle der Weisheit",
"Vivec, Hlaalu, Gefängniszellen", "Vivec, Jeanne; Trader", "Vivec, Milos Quartiere", "Vivec, Ralen Tilvur; Smith",
"Vivec, Hl.Olms, Unterirdische Kanäle", "Vivec, Telvanni, Verzauberungen"}
-- cells affected by the BMStartUpScript in the Bloodmoon expansion
local bmStartupCells = {"-20, 25", "-21, 23", "-22, 21", "-22, 23", "-24, 26", "-25, 19", "-26, 26", "Solstheim, Kammer des Lieds",
