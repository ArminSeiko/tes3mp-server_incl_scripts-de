...
local cellsWithNoQuickKeys = { "Seyda Neen, Zensus- und Steueramt" } -- This below table lets you insert cells that should temporarily remove quick keys for players.
