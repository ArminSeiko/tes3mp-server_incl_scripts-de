...
config.spawnsToDelete = {
	...
	--{cell = "Ebenherz, Saal des Großen Rates", uniqueIndex = "7404-0"}, -- apelles matius Mournhold Porter
...
--config.spawnsToDelete = {["Gnisis, Almu-Höhle"] = "12051-0", ["insert a cell name here"] = "######-0"}
